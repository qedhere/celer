...
export default function Header(props) {
  ...
  return (
    <div className="fixed h-[65px] w-full flex justify-center backdrop-blur-[5px] bg-[hsla(0,0%,100%,.8)] z-30">
      <div className="max-w-[1200px] grow flex flex-col items-center pr-4 z-0 pl-4">
        <div className="flex items-center grow w-full">
          ...
          {props.section ? (
            <>
              <div className="h-[24px] w-[1px] bg-gray-300 mr-4"></div>
        ...
        <div className="h-[1px] w-full flex">
          <div className="w-[100px] bg-gradient-to-r from-transparent to-neutral-200"></div>
          <div className="grow bg-neutral-200"></div>
          <div className="w-[100px] bg-gradient-to-l from-transparent to-neutral-200"></div>
        </div>
      </div>
